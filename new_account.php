...
<head>
  ...
  <title>Gary Bookstore - CREATE ACCOUNT</title>
  <link rel="icon" href="https://www.pngkit.com/png/full/335-3351353_the-application-process-create-account-icon-png.png">
...
<section class="main-fx">
  <h1>Gary Bookstore - CREATE ACCOUNT</h1>
  <form action="create.php" method="POST" name="create-form" id="create-form" onsubmit="return validate();">
    <div id="create" class="flex flex-center col-dir">
      ...
      <div id="form-button" class="flex flex-center row-dir">
        <button type="submit" name="confirm" id="confirm" class="mid-size">CONFIRM</button>
        <button type="button" name="back" id="back" class="mid-size">BACK</button>
      </div>
    </div>
  </form>
</section>
